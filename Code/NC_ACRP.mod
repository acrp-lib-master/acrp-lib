...
param uvrx{(i,j) in P} default qmax*(v0[i] + v0[j]);
param uvry{(i,j) in P} default qmax*(v0[i] + v0[j]);
param lvrx{(i,j) in P} default -qmax*(v0[i] + v0[j]);
param lvry{(i,j) in P} default -qmax*(v0[i] + v0[j]);

# gammal,gammau,phiu,phil parameters
param a{(i,j) in P} default 0;
param b{(i,j) in P} default 0;
param c{(i,j) in P} default 0;
param gammal{(i,j) in P} default 0;
param gammau{(i,j) in P} default 0;
param phil{(i,j) in P} default 0;
param phiu{(i,j) in P} default 0;
